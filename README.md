<a href="https://travis-ci.com/h4tr3d/iris"><img src="https://api.travis-ci.com/h4tr3d/iris.svg?branch=master&style=flat-square" alt="Build Status"></a>
<a href="http://goreportcard.com/report/h4tr3d/iris"><img src="https://img.shields.io/badge/report%20card%20-a%2B-F44336.svg?style=flat-square" alt="http://goreportcard.com/report/h4tr3d/iris"></a>
<a href="http://support.iris-go.com"><img src="https://img.shields.io/badge/support-page-ec2eb4.svg?style=flat-square" alt="Iris support forum"></a> <!-- <a href="https://github.com/h4tr3d/iris/blob/master/HISTORY.md"><img src="https://img.shields.io/badge/codename-√Νεxτ%20-blue.svg?style=flat-square" alt="CHANGELOG/HISTORY"></a> --><a href="https://github.com/h4tr3d/iris/tree/master/_examples#table-of-contents"><img src="https://img.shields.io/badge/examples-%20repository-3362c2.svg?style=flat-square" alt="Examples for new Gophers"></a>
<a href="https://godoc.org/gopkg.in/h4tr3d/iris.v6"><img src="https://img.shields.io/badge/docs-%20reference-5272B4.svg?style=flat-square" alt="Docs"></a>
...
- Build RESTful APIs
- Choose your favorite routes' path syntax between [httprouter](https://github.com/h4tr3d/iris/v6/blob/v6/_examples/beginner/routes-using-httprouter/main.go) and [gorillamux](https://github.com/h4tr3d/iris/v6/blob/v6/_examples/beginner/routes-using-gorillamux/main.go)
...
<a href="https://github.com/h4tr3d/iris/v6/tree/v6/_examples#table-of-contents"><img align="right" width="265" src="https://raw.githubusercontent.com/iris-contrib/website/gh-pages/assets/book/cover_4.jpg"></a>
...
-----------
 ...
 <a href="https://github.com/h4tr3d/iris/v6/tree/v6/_examples#table-of-contents"><img align="right" width="125" src="https://raw.githubusercontent.com/iris-contrib/website/gh-pages/assets/book/cover_4.jpg"></a>

1. [Getting Started with Go+Iris](http://gopherbook.iris-go.com)

2. Official small but practical [examples](https://github.com/h4tr3d/iris/v6/tree/v6/_examples#table-of-contents)
...
- [context_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/context_test.go)
- [handler_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/handler_test.go)
- [policy_gorillamux_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/policy_gorillamux_test.go)
- [policy_httprouter_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/policy_httprouter_test.go)
- [policy_nativerouter_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/policy_nativerouter_test.go)
- [policy_routerwrapper_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/policy_routerwrapper_test.go)
- [policy_sessions_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/policy_sessions_test.go)
- [response_writer_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/response_writer_test.go)
- [route_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/route_test.go)
- [status_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/status_test.go)
- [transaction_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/transaction_test.go)
- [serializer_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/serializer_test.go)

A simple test is located to [./_examples/advanced/httptest/main_test.go](https://github.com/h4tr3d/iris/v6/blob/v6/_examples/advanced/httptest/main_test.go)
...
Iris does not force you to use any specific ORM or template engine. Iris is routerless which means you can adapt any router you like, [httprouter](https://github.com/h4tr3d/iris/v6/blob/v6/_examples/beginner/routes-using-httprouter/main.go) is the fastest, [gorillamux](https://github.com/h4tr3d/iris/v6/blob/v6/_examples/beginner/routes-using-gorillamux/main.go) has more features. With support for the most used template engines (5), you can quickly craft the perfect application.
